(function () {
    ...
    var state = 'moving';   // 'moving' | 'stopped' | 'flying' | 'angry' | 'logo' | 'h1feast' | 'tooltile'
    var stateTimer = 0;
    ...
    function animateLoop() {
        ...
        if (!isCursorDestroyed && state !== 'angry' && state !== 'logo' && state !== 'h1feast' && state !== 'tooltile') {
        ...
        if (state !== 'h1feast' && state !== 'logo' && state !== 'angry' && state !== 'tooltile' && !isCursorDestroyed) {
        ...
        } else if (hunger > 38 && state !== 'angry' && state !== 'h1feast' && state !== 'logo' && state !== 'tooltile') {
        ...
        if (state !== 'stopped' && state !== 'logo' && state !== 'h1feast' && state !== 'tooltile') {
        ...
        var targetLift = (state === 'flying' || state === 'angry' || (state === 'logo' && logoSub === 'approach') || (state === 'h1feast' && h1Sub === 'approach') || (state === 'tooltile' && toolSub === 'approach')) ? 6 : 0;
